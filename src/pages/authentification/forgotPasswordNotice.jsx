...
export function ForgotNotice(){
  ...
  const resendLink=(event)=>{
    ...
    setLoading(true)
    axios.post(`${process.env.REACT_APP_BACKEND_URL}/resend-link-forgot`, {email}).then((res)=>{
  ...
  <div class="row">
    <div class="alert alert-success col-md-12" role="alert" id="notes">
      <h4>NOTES</h4>
      <ul>
        <li>Nous venons de vous envoyer un lien par mail. Pour changer votre mot de passe, cliquez dessus.</li>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="jumbotron text-center">
        <h2 className="mb-3">Verifiez vos mails et cliquez sur le lien de verification pour changer le mot de passe !</h2>
