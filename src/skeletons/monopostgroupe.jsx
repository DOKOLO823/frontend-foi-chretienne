...
export function MonoPublicationCardGroupeSkeleton()
{
    const pub=['']
    const tab=['', '', '','','']
       ...
       <div class="row d-flex align-items-center justify-content-center w-full">
           <div class=" w-full">
               ...
               <div class="d-flex flex-row ml-3 justify-content-between p-2 px-3">
                 ...
                 <Skeleton className="my-3" height='2rem' width='100%'></Skeleton>
                 <span className="flex flex-row items-center gap-x-3 w-full">
                 <Skeleton height='1rem' width='40%'></Skeleton> <Skeleton height='1rem' width='60%'></Skeleton>
                 </span>
                 <span className="flex flex-row items-center gap-x-3 w-full my-3">
                 <Skeleton height='1rem' width='40%'></Skeleton> <Skeleton height='1rem' width='60%'></Skeleton>
                 </span>
                 <span className="flex flex-col w-full gap-y-3 mt-3">
                 <Skeleton height='1rem' width='60%'></Skeleton> <Skeleton height='10rem' width='100%'></Skeleton>
                 </span>
                 </div>
