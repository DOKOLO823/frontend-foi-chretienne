...
export function DemandeSkeleton(){
    const tab=['','','','','','','','','','','','','','','']
    return <>
     <div className="h-full flex flex-row justify-center flex-wrap items-center gap-4 pb-24">
        {
            tab.map((e)=>{
                return <div style={{width:'300px'}} className='flex flex-col pb-3 border-gray-300 border-1 rounded-lg bg-white'>
             ...
             <div className="flex flex-row px-4 py-2 gap-x-2 w-full mb-1">
               <Skeleton height='40px' width='40px' className='rounded-full'></Skeleton>
                ...
                <span className='flex flex-row justify-center items-center w-full gap-x-4'>
                      <Skeleton height='35px' width='35%'></Skeleton>
                      <Skeleton height='35px' width='35%'></Skeleton>
                    </span>
            </div>
            })
